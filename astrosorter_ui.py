...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/icons/moon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/icons/open folder icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.openInputFolderButton.setIcon(icon1)
        ...
        self.openOutputFolderButton.setIcon(icon1)
